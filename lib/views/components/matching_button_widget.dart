    ...
    return ClipRRect(
      ...
      child: Container(
        decoration: BoxDecoration(boxShadow: [
          //내부 그림자
          BoxShadow(
            color: screenArguments.status == 'AppliedAndNotMatched' ||
                    screenArguments.status == 'AppliedAndMatched'
                ? const Color(0xffCBCBCB)
                : const Color(0xff678CFF),
          ),
          //버튼색
          BoxShadow(
            blurRadius: 7,
            ...
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: screenArguments.status == 'AppliedAndNotMatched' ||
                          screenArguments.status == 'AppliedAndMatched'
                      ? const Color(0xffD7D7D7) // 회색
                      : const Color(0xFF99B1FF), //하늘
                  ...
                  Row(
                    ...
                    children: [
                      screenArguments.status == 'AppliedAndNotMatched' ||
                              screenArguments.status == 'AppliedAndMatched'
                          ? SvgPicture.asset(
                              'assets/character/none_puzzle.svg',
                              width: 100.r,
                            )
                          : SvgPicture.asset(
                              'assets/character/matching_puzzle.svg',
                              width: 100.r,
                            )
                    ],
                  ),
