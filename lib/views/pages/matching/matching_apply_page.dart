          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: Container(
                  margin:
                      EdgeInsets.only(right: 130.w, top: 10.h, bottom: 10.h),
                  decoration: BoxDecoration(
                      color: const Color(0xff7898ff),
                  ...
                  height: 37.h,
                  child: Text(
                    '\u{1F9E1}\u{1F49B}\u{1F49A}\u{1F499}',
                    style: TextStyle(
                      fontSize: 20.spMin,
                    ),
                  ),
              ...
              RichText(
                text: TextSpan(children: [
                  TextSpan(
                    text: 'matching-preferlan'.tr(),
                    style: TextStyle(
                        fontSize: 16.spMin, color: const Color(0xff3666FF)),
                  ),
                  TextSpan(
                      text: 'matching-matchdone'.tr(),
                      style: TextStyle(
                          fontSize: 16.spMin, color: Colors.black, height: 2)),
                ]),
              ),
              RichText(
                text: TextSpan(children: [
                  TextSpan(
                    ...
                    style: TextStyle(
                      fontSize: 16.spMin,
                      color: const Color(0xff3666FF),
                    ),
                  ),
                  TextSpan(
                      text: 'matching-add'.tr(),
                      style:
                          TextStyle(fontSize: 16.spMin, color: Colors.black)),
                ]),
              ),
              SizedBox(
                height: 120.h,
