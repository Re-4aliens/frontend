                    ...
                    ListTile(
                      ...
                      title: Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${gameBoardList[index].member!.nickname}',
                            style: TextStyle(
                      ...
                      subtitle: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            gameBoardList[index].imageUrls == null ?
                            SizedBox():
                            Container(
                              height: 100,
                              child: ListView.builder(
                                  scrollDirection: Axis.horizontal,
                                  itemCount: gameBoardList[index].imageUrls!.length,
                                  itemBuilder: (context, index){
                                    return Row(
                                      children: [
                                        Container(
                            ...
                            Padding(
                              ...
                              child: Text('${gameBoardList[index].title}', style: TextStyle(fontSize: 16),),
                            ),
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: gameBoardList[index].likeCount == 0
                                      ? Text('')
                                      : Text(
                                      '${gameBoardList[index].likeCount}'),
                                ),
                                Padding(
                                  padding: const EdgeInsets.all(4.0),
                                  child: Icon(
                                ...
                                Padding(
                                  padding: const EdgeInsets.all(4.0),
                                  child: Text(
                                      '${gameBoardList[index].commentCount}'),
                                ),
                              ],
                            )
                          ],
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => ArticlePage(board: gameBoardList[index], boardCategory: "자유게시판")),
