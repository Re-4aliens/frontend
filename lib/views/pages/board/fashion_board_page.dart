                          ...
                          ListTile(
                            ...
                            title: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${fashionBoardList[index].member!.nickname}',
                                  style: TextStyle(
                            ...
                            subtitle: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  fashionBoardList[index].imageUrls == null
                                      ? SizedBox()
                                      : Container(
                                          height: 100,
                                          child: ListView.builder(
                                              scrollDirection: Axis.horizontal,
                                              itemCount: fashionBoardList[index]
                                                  .imageUrls!
                                                  .length,
                                              itemBuilder: (context, index) {
                                                return Row(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding:
                                            EdgeInsets.only(left: 4, right: 15),
                                        child: fashionBoardList[index]
                                                    .likeCount ==
                                                0
                                            ? Text('')
                                            : Text(
                                                '${fashionBoardList[index].likeCount}'),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.all(4.0),
                                        child: Icon(
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(4.0),
                                        child: Text(
                                            '${fashionBoardList[index].commentCount}'),
                                      ),
                                    ],
                                  )
                                ],
