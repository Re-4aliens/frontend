                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: UnderlineInputBorder(
                          borderSide: BorderSide(color: Color(0xffEBEBEB)), // 원하는 색상으로 설정
                        ),
                  ...
                  maxLength: 30,
                            ...
                            child: Row(
                              children:
                                whatStatus.map((condition) {
                                  final bool isSelected = productStatus == condition;
                                  return Padding(
                                    ...
                                    child: ChoiceChip(
                                      label: Text(
                                          ...
                                          style: TextStyle(
                                            ...
                                            color: isSelected ? Colors.white : Color(0xffC1C1C1),
                                          ),
                                      ),
                                      selected: isSelected,
                                      backgroundColor: isSelected? Color(0xff7898FF):Colors.white,
                                      selectedColor: Color(0xff7898ff),
                                      onSelected: (isSelected) {
                                        setState(() {
                                          productStatus = isSelected ? condition : '';
                                        });
                                      },
                                      labelPadding: EdgeInsets.only(left: 12, right:12), // 선택 영역 패딩 조절
                                      shape: RoundedRectangleBorder(
                                        side: BorderSide(
                                          color: isSelected ? Color(0xff7898FF) : Color(0xffC1C1C1),
                                        ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabledBorder: UnderlineInputBorder(
                            borderSide: BorderSide(color: Colors.transparent), // 원하는 색상으로 설정
                          ),
