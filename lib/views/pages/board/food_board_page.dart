                    ...
                    ListTile(
                      ...
                      title: Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${foodBoardList[index].member!.nickname}',
                            style: TextStyle(
                      ...
                      subtitle: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            foodBoardList[index].imageUrls == null ?
                            SizedBox():
                            Container(
                              height: 100,
                              child: ListView.builder(
                                  scrollDirection: Axis.horizontal,
                                  itemCount: foodBoardList[index].imageUrls!.length,
                                  itemBuilder: (context, index){
                                    return Row(
                                      children: [
                                        Container(
                            ...
                            Padding(
                              ...
                              child: Text('${foodBoardList[index].title}', style: TextStyle(fontSize: 16),),
                            ),
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: foodBoardList[index].likeCount == 0
                                      ? Text('')
                                      : Text(
                                      '${foodBoardList[index].likeCount}'),
                                ),
                                Padding(
                                  padding: const EdgeInsets.all(4.0),
                                  child: Icon(
                                ...
                                Padding(
                                  padding: const EdgeInsets.all(4.0),
                                  child: Text(
                                      '${foodBoardList[index].commentCount}'),
                                ),
                              ],
                            )
                          ],
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => ArticlePage(board: foodBoardList[index], boardCategory: "자유게시판")),
