...
import '../models/notice_article.dart';
...
List<Board> gameBoardList = [gameBoard1, gameBoard2];

List<Board> fashionBoardList = [fashionBoard1, fashionBoard2];

List<Board> foodBoardList = [foodBoard1];

List<Board> musicBoardList = [musicBoard1, musicBoard2, musicBoard3];

List<Board> infoBoardList = [infoBoard1, infoBoard2, infoBoard3];

List<Board> MyPostingBoardList = [
  MyPostingBoard1,
];

List<Board> NotificationList = [Notification1, Notification2];
